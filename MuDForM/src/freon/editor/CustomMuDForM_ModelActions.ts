...
/**
 * Class CustomMuDForM_ModelActions provides an entry point for the language engineer to
 ...
 */
export class CustomMuDForM_ModelActions implements FreCombinedActions {
