...
import { ProductValueType } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type ProductValueType.
 ...
 */
export class ProductValueTypeBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "ProductValueType";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as ProductValueType, "ProductValueType-overall", "", [
            BoxFactory.horizontalLayout(
                this._node as ProductValueType,
                "ProductValueType-hlist-line-0",
                "",
                [
                    BoxUtil.labelBox(this._node as ProductValueType, "ProductValueType", "top-1-line-0-item-0"),
                    BoxUtil.labelBox(this._node as ProductValueType, "\{", "top-1-line-0-item-1"),
                ],
                { selectable: false },
            ),
            BoxUtil.indentBox(
                ...
                4,
                "1",
                BoxUtil.labelBox(this._node as ProductValueType, "fields", "top-1-line-1-item-0"),
            ),
            BoxUtil.indentBox(
                this._node as ProductValueType,
                8,
                ...
                BoxUtil.verticalPartListBox(
                    this._node as ProductValueType,
                    (this._node as ProductValueType).fields,
                    "fields",
                    null,
                    this.mainHandler,
                ),
            ),
            BoxUtil.labelBox(this._node as ProductValueType, "}", "top-1-line-3-item-0"),
        ]);
    }
}
