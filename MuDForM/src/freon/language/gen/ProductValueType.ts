...
/**
 * Class ProductValueType is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class ProductValueType extends ValueType implements FreNode {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<ProductValueType>): ProductValueType {
        const result = new ProductValueType(data.$id);
        if (!!data.fields) {
    ...
    readonly $typename: string = "ProductValueType"; // holds the metatype in the form of a string
     ...
     */
    copy(): ProductValueType {
        const result = new ProductValueType();
        if (!!this.fields) {
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<ProductValueType>): boolean {
