...
/**
 * Class TransitionDef is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export class TransitionDef extends MobxModelElementImpl implements FreNamedNode {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data partial object
     */
    static create(data: Partial<TransitionDef>): TransitionDef {
        const result = new TransitionDef(data.$id);
        if (!!data.name) {
    ...
    readonly $typename: string = "TransitionDef"; // holds the metatype in the form of a string
     ...
     */
    copy(): TransitionDef {
        const result = new TransitionDef();
        if (!!this.name) {
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<TransitionDef>): boolean {
