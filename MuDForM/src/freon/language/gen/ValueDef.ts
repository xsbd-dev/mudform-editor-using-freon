...
/**
 * Class ValueDef is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to the changes in the state of its properties.
 */
export abstract class ValueDef extends MobxModelElementImpl implements FreNamedNode {
    readonly $typename: string = "ValueDef"; // holds the metatype in the form of a string
     ...
     */
    copy(): ValueDef {
        console.log("ValueDef: copy method should be implemented by concrete subclass");
        return null;
    }
    /**
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<ValueDef>): boolean {
