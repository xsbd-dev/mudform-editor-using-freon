...
const LOGGER = new FreLogger("MuDForM_ModelScoper");

/**
 * Class MuDForM_ModelScoper implements the scoper generated from, if present, the scoper definition,
 * otherwise this class implements the default scoper.
 */
export class MuDForM_ModelScoper extends FreScoperBase {
    /**
