...
import { SimpleValueType, ValueTypeReference, ValueAttribute, ReferenceAttribute } from "../../language/gen/index.js";
...
export class MuDForM_ModelReferenceChecker extends MuDForM_ModelDefaultWorker implements MuDForM_ModelCheckerInterface {
    ...
    public execBeforeSimpleValueType(modelelement: SimpleValueType): boolean {
        if (!!modelelement.primitive_type && modelelement.primitive_type.referred === null) {
            this.makeErrorMessage(modelelement, modelelement.primitive_type, "primitive_type", `${"unnamed"}`);
        }
        return false;
    }
    ...
    public execBeforeValueTypeReference(modelelement: ValueTypeReference): boolean {
        if (!!modelelement.defRef && modelelement.defRef.referred === null) {
            this.makeErrorMessage(modelelement, modelelement.defRef, "defRef", `${"unnamed"}`);
        }
        return false;
    }
    ...
    public execBeforeValueAttribute(modelelement: ValueAttribute): boolean {
        if (!!modelelement.valueRef && modelelement.valueRef.referred === null) {
            this.makeErrorMessage(modelelement, modelelement.valueRef, "valueRef", `${"unnamed"}`);
        }
        return false;
    }
    ...
    public execBeforeReferenceAttribute(modelelement: ReferenceAttribute): boolean {
        if (!!modelelement.entityRef && modelelement.entityRef.referred === null) {
            this.makeErrorMessage(modelelement, modelelement.entityRef, "entityRef", `${"unnamed"}`);
        }
        return false;
    }
