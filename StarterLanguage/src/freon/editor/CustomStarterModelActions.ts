...
/**
 * Class CustomStarterModelActions provides an entry point for the language engineer to
 ...
 */
export class CustomStarterModelActions implements FreCombinedActions {
