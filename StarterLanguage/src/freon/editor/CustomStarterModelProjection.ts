...
/**
 * Class CustomStarterModelProjection provides an entry point for the language engineer to
 ...
 */
export class CustomStarterModelProjection implements FreProjection {
    name: string = "Custom";
