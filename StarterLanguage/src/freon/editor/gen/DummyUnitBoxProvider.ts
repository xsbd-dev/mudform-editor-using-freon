...
/**
 * This class implements the box provider for a single node of type DummyUnit.
 ...
 */
export class DummyUnitBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "DummyUnit";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as DummyUnit, "DummyUnit-overall", "", [
            BoxFactory.horizontalLayout(
                this._node as DummyUnit,
                "DummyUnit-hlist-line-0",
                "",
                [
                    BoxUtil.labelBox(this._node as DummyUnit, "DummyUnit", "top-1-line-0-item-0"),
                    BoxUtil.textBox(this._node as DummyUnit, "name"),
                    BoxUtil.labelBox(this._node as DummyUnit, "\{", "top-1-line-0-item-2"),
                ],
                { selectable: false },
            ),
            BoxUtil.labelBox(this._node as DummyUnit, "}", "top-1-line-1-item-0"),
        ]);
    }
}
