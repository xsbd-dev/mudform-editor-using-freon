...
import { StarterModelInterpreterInit } from "./gen/StarterModelInterpreterInit.js";
 ...
 */
export class MainStarterModelInterpreter implements FreInterpreter {
    private static main: IMainInterpreter = null;

    constructor() {
        if (MainStarterModelInterpreter.main === null) {
            MainStarterModelInterpreter.main = MainInterpreter.instance(
                StarterModelInterpreterInit,
                getConceptFunction,
                getPropertyFunction,
            );
        }
    ...
    setTracing(value: boolean) {
        MainStarterModelInterpreter.main.setTracing(value);
    }

    getTrace(): InterpreterTracer {
        return MainStarterModelInterpreter.main.getTrace();
    }
    ...
    evaluateWithContext(node: Object, ctx: InterpreterContext): RtObject {
        MainStarterModelInterpreter.main.reset();
        try {
            return MainStarterModelInterpreter.main.evaluate(node, ctx);
        } catch (e: any) {
