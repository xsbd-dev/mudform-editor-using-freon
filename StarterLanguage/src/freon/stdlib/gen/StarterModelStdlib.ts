...
/**
 * Class StarterModelStdlib provides an entry point for all predefined elements in language StarterModel.
 ...
 */
export class StarterModelStdlib implements FreStdlib {
    ...
    public static getInstance(): FreStdlib {
        if (this.stdlib === undefined || this.stdlib === null) {
            this.stdlib = new StarterModelStdlib();
        }
        return this.stdlib;
    }

    public elements: FreNamedNode[] = []; // the predefined elements of language StarterModel
